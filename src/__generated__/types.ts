...
export type BookStayVariables = Exact<{
  createBookingInput?: InputMaybe<CreateBookingInput>;
}>;

export type BookStay = {
  createBooking: {
    __typename?: "CreateBookingResponse";
    success: boolean;
    message: string;
...
export type GetAllAmenitiesVariables = Exact<{ [key: string]: never }>;

export type GetAllAmenities = {
...
export type SubmitHostAndLocationReviewsVariables = Exact<{
  bookingId: Scalars["ID"]["input"];
  hostReview: ReviewInput;
  locationReview: ReviewInput;
}>;

export type SubmitHostAndLocationReviews = {
...
export type GetCurrrentAndUpcomingBookingsForHostListingVariables = Exact<{
  listingId: Scalars["ID"]["input"];
  upcomingStatus?: InputMaybe<BookingStatus>;
  currentStatus?: InputMaybe<BookingStatus>;
}>;

export type GetCurrrentAndUpcomingBookingsForHostListing = {
...
export type GetListingVariables = Exact<{
  id: Scalars["ID"]["input"];
}>;
...
export type GetFeaturedListingsVariables = Exact<{ [key: string]: never }>;

export type GetFeaturedListings = {
...
export type GetListingDetailsVariables = Exact<{
  id: Scalars["ID"]["input"];
}>;
...
export type SubmitGuestReviewVariables = Exact<{
  bookingId: Scalars["ID"]["input"];
  guestReview: ReviewInput;
}>;

export type SubmitGuestReview = {
  submitGuestReview: {
    __typename?: "SubmitGuestReviewResponse";
    success: boolean;
    message: string;
...
export type GetPastBookingsForHostListingVariables = Exact<{
  listingId: Scalars["ID"]["input"];
  status?: InputMaybe<BookingStatus>;
}>;

export type GetPastBookingsForHostListing = {
  listing: { __typename?: "Listing"; id: string; title: string } | null;
...
export type GetPastTripsVariables = Exact<{ [key: string]: never }>;

export type GetPastTrips = {
...
export type SearchListingsVariables = Exact<{
...
export type GetGuestTripsVariables = Exact<{ [key: string]: never }>;

export type GetGuestTrips = {
...
export type AddFundsVariables = Exact<{
  amount: Scalars["Float"]["input"];
}>;
...
export type GetMyProfileVariables = Exact<{ [key: string]: never }>;
...
export type GetHostListingsVariables = Exact<{ [key: string]: never }>;
